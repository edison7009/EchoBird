                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {isProcessing ? (
                                ...
                                <button
                                    ...
                                    className="aspect-square h-full rounded-md flex items-center justify-center bg-cyber-accent-secondary hover:brightness-110 transition-all disabled:opacity-20"
                                >
