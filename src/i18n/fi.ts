...
const fi: Partial<Translations> = {
    ...
    'ssh.winStep1': 'Asetukset → Järjestelmä → Valinnaiset ominaisuudet → Näytä ominaisuudet',
    'ssh.winStep2': 'Hae "OpenSSH" → Lisää OpenSSH Server',
    'ssh.winStep3': 'Napsauta Käynnistä hiiren kakkospainikkeella → Pääte (järjestelmänvalvoja) tai PowerShell (järjestelmänvalvoja):',    'ssh.winStep3Hint': 'Suorita kaikki 3 komentoa alla:',
