...
const fi: Partial<Translations> = {
    'app.name': 'Echobird',
    'nav.modelNexus': 'Mallikeskus', 'nav.skillBrowser': 'Taitoselain', 'nav.appManager': 'Sovellushallinta', 'nav.localServer': 'Paikallinen LLM', 'nav.logsDebug': 'Lokit ja virheenkorjaus',
    'page.modelNexus': 'MALLIKESKUS', 'page.skillBrowser': 'TAITOSELAIN', 'page.appManager': 'SOVELLUSHALLINTA', 'page.localServer': 'PAIKALLINEN LLM', 'page.logsDebug': 'LOKIT JA VIRHEENKORJAUS',
    ...
    'mother.hintInstallOC': 'Asenna OpenClaw',
    'mother.hintInstallSkills': 'Asenna taidot OpenClawille',
    'mother.hintDeployLlm': 'Ota LLM käyttöön etänä',
    'mother.hintShowSpecs': 'Näytä palvelimen tiedot',
    'mother.hintUninstallOC': 'Poista OpenClaw kokonaan',
