...
const en: Translations = {
    ...
    'ssh.winNote': 'Windows SSH deployment is more complex than Linux/macOS. Recommended: install EchoBird on the Windows machine first, then use Install & Repair to set up local SSH access for you.',
