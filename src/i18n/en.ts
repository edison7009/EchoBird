...
const en: Translations = {
    ...
    'ssh.winStep1': 'Settings → System → Optional Features → View features',
    'ssh.winStep2': 'Search "OpenSSH" → Add OpenSSH Server',
    'ssh.winStep3': 'Right-click Start → Terminal (Admin) or PowerShell (Admin):',
    'ssh.winStep3Hint': 'Run all 3 commands below:',
