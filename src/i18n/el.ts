...
const el: Partial<Translations> = {
    'app.name': 'Echobird',
    'nav.modelNexus': 'Κέντρο Μοντέλων', 'nav.skillBrowser': 'Περιηγητής Δεξιοτήτων', 'nav.appManager': 'Διαχείριση Εφαρμογών', 'nav.localServer': 'Τοπικό LLM', 'nav.logsDebug': 'Αρχεία & Αποσφαλμάτωση',
    'page.modelNexus': 'ΚΕΝΤΡΟ ΜΟΝΤΕΛΩΝ', 'page.skillBrowser': 'ΠΕΡΙΗΓΗΤΗΣ ΔΕΞΙΟΤΗΤΩΝ', 'page.appManager': 'ΔΙΑΧΕΙΡΙΣΗ ΕΦΑΡΜΟΓΩΝ', 'page.localServer': 'ΤΟΠΙΚΟ LLM', 'page.logsDebug': 'ΑΡΧΕΙΑ & ΑΠΟΣΦΑΛΜΑΤΩΣΗ',
