...
const el: Partial<Translations> = {
    ...
    'ssh.winStep1': 'Ρυθμίσεις → Σύστημα → Προαιρετικές δυνατότητες → Προβολή δυνατοτήτων',
    'ssh.winStep2': 'Αναζήτηση "OpenSSH" → Προσθήκη OpenSSH Server',
    'ssh.winStep3': 'Δεξί κλικ στο Έναρξη → Τερματικό (Διαχειριστής) ή PowerShell (Διαχειριστής):',
    'ssh.winStep3Hint': 'Εκτελέστε και τις 3 εντολές παρακάτω:',
