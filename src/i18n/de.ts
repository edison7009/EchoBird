...
const de: Partial<Translations> = {
    ...
    'ssh.winStep1': 'Einstellungen → System → Optionale Features → Features anzeigen',
    'ssh.winStep2': '"OpenSSH" suchen → OpenSSH Server hinzufügen',
    'ssh.winStep3': 'Rechtsklick auf Start → Terminal (Admin) oder PowerShell (Admin):',
    'ssh.winStep3Hint': 'Alle 3 Befehle der Reihe nach ausführen:',
