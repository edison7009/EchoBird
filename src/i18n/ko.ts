...
const ko: Partial<Translations> = {
    ...
    'ssh.winStep1': '설정 → 시스템 → 선택적 기능 → 기능 보기',
    'ssh.winStep2': '"OpenSSH" 검색 → OpenSSH 서버 추가',
    'ssh.winStep3': '시작 우클릭 → 터미널(관리자) 또는 PowerShell(관리자):',
    'ssh.winStep3Hint': '아래 3가지 명령어를 순서대로 실행하세요:',
