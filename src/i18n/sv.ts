...
const sv: Partial<Translations> = {
    ...
    'ssh.winStep1': 'Inställningar → System → Valfria funktioner → Visa funktioner',
    'ssh.winStep2': 'Sök "OpenSSH" → Lägg till OpenSSH Server',
    'ssh.winStep3': 'Högerklicka på Start → Terminal (Admin) eller PowerShell (Admin):',
    'ssh.winStep3Hint': 'Kör alla 3 kommandon nedan i ordning:',
