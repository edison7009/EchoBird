...
const sv: Partial<Translations> = {
    'app.name': 'Echobird',
    'nav.modelNexus': 'Modellcenter', 'nav.skillBrowser': 'Färdighetsbläddrare', 'nav.appManager': 'Apphanterare', 'nav.localServer': 'Lokal LLM', 'nav.logsDebug': 'Loggar & Felsökning',
    'page.modelNexus': 'MODELLCENTER', 'page.skillBrowser': 'FÄRDIGHETSBLÄDDRARE', 'page.appManager': 'APPHANTERARE', 'page.localServer': 'LOKAL LLM', 'page.logsDebug': 'LOGGAR & FELSÖKNING',
