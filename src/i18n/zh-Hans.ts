...
const zhHans: Partial<Translations> = {
    ...
    'ssh.cloudIp': '在控制台中查看',
    'ssh.winStep1': '下载并安装',
    'ssh.winStep2': "点击 'Open easy settings' → 'Virtual accounts' → 'Add'",
    'ssh.winStep3': "设置虚拟账号名/密码，保存并点击 'Start server'",
    'ssh.winUsername': 'Virtual account name（虚拟账号名）',
    'ssh.winPassword': 'Virtual account password（虚拟账号密码）',
