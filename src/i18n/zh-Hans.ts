...
const zhHans: Partial<Translations> = {
    ...
    'channel.selectRoleAgent': '选择角色和 CLI Agent',
    ...
    'ssh.cloudIp': '在控制台中查看',
    'ssh.winStep1': '设置 → 系统 → 可选功能 → 查看功能',
    'ssh.winStep2': '搜索"OpenSSH" → 添加 OpenSSH 服务器',
    'ssh.winStep3': '右键「开始」→ 终端(管理员) 或 PowerShell(管理员)：',    'ssh.winStep3Hint': '依次运行以下 3 条命令：',
