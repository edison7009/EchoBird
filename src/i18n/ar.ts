...
const ar: Partial<Translations> = {
    ...
    'ssh.winStep1': 'الإعدادات → النظام → الميزات الاختيارية → عرض الميزات',
    'ssh.winStep2': 'ابحث عن "OpenSSH" → أضف OpenSSH Server',
    'ssh.winStep3': 'انقر بزر الماوس الأيمن على «ابدأ» → الطرفية (مسؤول) أو PowerShell (مسؤول):',
    'ssh.winStep3Hint': 'شغّل الأوامر الثلاثة التالية:',
