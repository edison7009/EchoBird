...
const ar: Partial<Translations> = {
    ...
    'channel.remoteLlm': 'LLM عن بعد:',
    'channel.llmPanel': 'لوحة LLM →',
    'channel.deployFirst': 'أكمل نشر Agent أولاً',
    'channel.failed': 'فشل',
