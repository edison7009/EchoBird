...
const ja: Partial<Translations> = {
    ...
    'ssh.winStep1': '設定 → システム → オプション機能 → 機能を表示',
    'ssh.winStep2': '「OpenSSH」を検索 → OpenSSH Server を追加',
    'ssh.winStep3': 'スタートを右クリック → ターミナル（管理者）または PowerShell（管理者）：',
    'ssh.winStep3Hint': '以下の 3 つのコマンドを順番に実行してください：',
