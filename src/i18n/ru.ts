...
const ru: Partial<Translations> = {
    ...
    'ssh.winStep1': 'Параметры → Система → Дополнительные компоненты → Просмотр компонентов',
    'ssh.winStep2': 'Найдите «OpenSSH» → Добавьте OpenSSH Server',
    'ssh.winStep3': 'ПКМ по «Пуск» → Терминал (администратор) или PowerShell (администратор):',
    'ssh.winStep3Hint': 'Выполните по очереди все 3 команды ниже:',
