...
const he: Partial<Translations> = {
    'app.name': 'Echobird',
    'nav.modelNexus': 'מרכז מודלים', 'nav.skillBrowser': 'דפדפן כישורים', 'nav.appManager': 'מנהל אפליקציות', 'nav.localServer': 'LLM מקומי', 'nav.logsDebug': 'לוגים וניפוי',
    'page.modelNexus': 'מרכז מודלים', 'page.skillBrowser': 'דפדפן כישורים', 'page.appManager': 'מנהל אפליקציות', 'page.localServer': 'LLM מקומי', 'page.logsDebug': 'לוגים וניפוי',
    ...
    'mother.hintInstallOC': 'התקן OpenClaw',
    'mother.hintInstallSkills': 'התקן כישורים ל-OpenClaw',
    'mother.hintDeployLlm': 'פרוס LLM מרחוק',
    'mother.hintShowSpecs': 'הצג מפרט שרת',
    'mother.hintUninstallOC': 'הסר לחלוטין OpenClaw',
