...
const he: Partial<Translations> = {
    ...
    'ssh.winStep1': 'הגדרות → מערכת → תכונות אופציונליות → הצג תכונות',
    'ssh.winStep2': 'חפש "OpenSSH" → הוסף OpenSSH Server',
    'ssh.winStep3': 'לחץ לחיצה ימנית על התחל → מסוף (מנהל) או PowerShell (מנהל):',
    'ssh.winStep3Hint': 'הפעל את 3 הפקודות הבאות:',
