...
const fa: Partial<Translations> = {
    'app.name': 'Echobird',
    'nav.modelNexus': 'مرکز مدل‌ها', 'nav.skillBrowser': 'مرورگر مهارت‌ها', 'nav.appManager': 'مدیریت برنامه‌ها', 'nav.localServer': 'LLM محلی', 'nav.logsDebug': 'گزارش‌ها و اشکال‌زدایی',
    'page.modelNexus': 'مرکز مدل‌ها', 'page.skillBrowser': 'مرورگر مهارت‌ها', 'page.appManager': 'مدیریت برنامه‌ها', 'page.localServer': 'LLM محلی', 'page.logsDebug': 'گزارش‌ها و اشکال‌زدایی',
    ...
    'channel.remoteLlm': 'LLM از راه دور:',
    'channel.llmPanel': 'پنل LLM →',
    'channel.deployFirst': 'ابتدا استقرار Agent را تکمیل کنید',
    ...
    'mother.deployHint': 'هر Agent را از طریق چت مستقر کنید، مثلاً:',
    'mother.awaitingInit': '> در انتظار راه‌اندازی Mother Agent...',
    'mother.flowHint': 'انتخاب مدل → افزودن سرور → استقرار',
    'mother.hintInstallOC': 'نصب OpenClaw',
    'mother.hintInstallSkills': 'نصب مهارت‌ها برای OpenClaw',
    'mother.hintDeployLlm': 'استقرار LLM از راه دور',
    'mother.hintShowSpecs': 'نمایش مشخصات سرور',
    'mother.hintUninstallOC': 'حذف کامل OpenClaw',
