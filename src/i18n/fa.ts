...
const fa: Partial<Translations> = {
    ...
    'ssh.winStep1': 'تنظیمات → سیستم → ویژگی‌های اختیاری → مشاهده ویژگی‌ها',
    'ssh.winStep2': 'جستجوی "OpenSSH" → افزودن OpenSSH Server',
    'ssh.winStep3': 'کلیک راست روی Start ← ترمینال (مدیر) یا PowerShell (مدیر):',
    'ssh.winStep3Hint': 'هر ۳ دستور زیر را اجرا کنید:',
